...
# Instructions from https://github.com/hoene/libsofa/blob/master/README.md
...
if [ -d "libsofa" ]; then
  echo "The libsofa directory already exists. Skipping the download."
else
  git clone https://github.com/hoene/libsofa
fi
